...
Fill in here... If you include it, describe that you mapped mosquito blood meals and WNV-positive pools across space. Explain how this visualization can reveal whether the two overlap geographically, providing another way to evaluate your hypothesis.

```{r second-analysis-or-plot, include=TRUE, eval=TRUE, warning=FALSE, fig.align='left'}
library(dplyr)
library(tidyr)
library(ggplot2)
