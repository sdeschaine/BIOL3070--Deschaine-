...
We  made a split violin plot to compare firefly counts in the north and south. The plot shows the distribution of counts on each side, with colors for each region and the y-axis capped at 50 to keep it readable.
