...
# ----- REMOVE OUTLIERS ABOVE 50 -----
fireflies_no_outliers <- fireflies_clean %>%
  filter(firefly_count <= 50)

# ----- LINEAR REGRESSION PLOT -----
ggplot(fireflies_no_outliers, aes(x = region, y = firefly_count)) +
...
# Linear model
model <- lm(firefly_count ~ region, data = fireflies_no_outliers)
summary(model)
